    ...
    <div>
      ...
      <div className="grupo-1">
        <div className="box">
          <figure>
            <a href="#">
              <img src="./arcadelogo.png" alt="Logo png" />
            </a>
          </figure>
        </div>
        <div className="box">
          <h2>HORARIOS</h2>
          <p>Nos encontramos de Lunes a Viernes de 10HS a 17HS, consultas al wassap las 24hs del dia.</p>
      ...
      <div className="grupo-2">
        <small>&copi; 2024<b>RETROGAMER</b>-Todos los derechos Reservados</small>
      </div>
      </footer>
